...
@section('title', 'Adaugă Serviciu - Admin')
    ...
    <div class="row">
        ...
        <div class="col-md-9">
            ...
            <div class="card shadow-sm">
                <div class="card-body">
                    <form action="{{ route('admin.services-crud.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select name="sub_brand" class="form-select @error('sub_brand') is-invalid @enderror" required>
                                    ...
                                    <option value="dariaNails" {{ old('sub_brand') == 'dariaNails' ? 'selected' : '' }}>dariaNails</option>
                                    <option value="dariaHair" {{ old('sub_brand') == 'dariaHair' ? 'selected' : '' }}>dariaHair</option>
                                    <option value="dariaGlow" {{ old('sub_brand') == 'dariaGlow' ? 'selected' : '' }}>dariaGlow</option>
                                </select>
                                @error('sub_brand')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="row">
                            <div class="col-md-8 mb-3">
                                ...
                                <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" 
                                       value="{{ old('name') }}" placeholder="Ex: Manichiură Gel" required>
                                @error('name')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" name="category" class="form-control @error('category') is-invalid @enderror" 
                                       value="{{ old('category') }}" placeholder="Ex: Manichiură" required>
                                @error('category')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="description" class="form-control @error('description') is-invalid @enderror" 
                                      rows="3" placeholder="Descriere serviciu...">{{ old('description') }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" name="price" class="form-control @error('price') is-invalid @enderror" 
                                       value="{{ old('price') }}" min="0" step="0.01" placeholder="Ex: 80.00" required>
                                @error('price')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" name="duration" class="form-control @error('duration') is-invalid @enderror" 
                                       value="{{ old('duration') }}" min="15" step="15" placeholder="Ex: 60" required>
                                @error('duration')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="d-flex gap-2">
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-save me-2"></i>Salvează Serviciu
                            </button>
