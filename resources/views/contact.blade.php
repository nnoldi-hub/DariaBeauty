...
@section('title','Contact - DariaBeauty')
        ...
        <div class="bg-white rounded-4 shadow-sm p-4 border">
          ...
          <form method="POST" action="{{ route('contact.store') }}" class="row g-3">
            ...
            <div class="col-md-6">
              ...
              <input type="text" name="subject" class="form-control rounded-3" required value="{{ old('subject') }}"
            ...
            <div class="col-12">
              ...
              <textarea name="message" class="form-control rounded-3" rows="5" required 
                        placeholder="Scrie aici mesajul tău...">{{ old('message') }}</textarea>
            </div>
            <div class="col-12">
