        ...
        <div class="row align-items-center">
            <div class="col-lg-6">
                ...
                <div class="d-flex gap-3 flex-wrap">
                    <a href="<?php echo e(route('booking.landing')); ?>" class="btn btn-light btn-lg px-5 rounded-pill" 
                       style="color: #D4AF37; font-weight: 600;">
                        <i class="fas fa-calendar-alt me-2"></i>Programează-te
                    </a>
                    <a href="<?php echo e(route('specialists.index')); ?>" class="btn btn-outline-light btn-lg px-5 rounded-pill">
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-4">
                <div class="bg-white rounded-4 shadow-sm p-4 h-100 border" 
                    ...
                    <a href="<?php echo e(route('darianails')); ?>" class="btn btn-sm btn-outline-primary w-100 rounded-pill">
            ...
            <div class="col-lg-4">
                <div class="bg-white rounded-4 shadow-sm p-4 h-100 border" 
                    ...
                    <a href="<?php echo e(route('dariahair')); ?>" class="btn btn-sm btn-outline-primary w-100 rounded-pill">
                        Descoperă serviciile →
                    </a>
                </div>
            </div>
            ...
            <div class="col-lg-4">
                <div class="bg-white rounded-4 shadow-sm p-4 h-100 border" 
                    ...
                    <a href="<?php echo e(route('dariaglow')); ?>" class="btn btn-sm btn-outline-primary w-100 rounded-pill">
                        Descoperă serviciile →
                    </a>
                </div>
            </div>
...
<section class="py-5" style="background: linear-gradient(135deg, #D4AF37 0%, #8B6914 100%);">
    <div class="container text-center text-white">
        ...
        <div class="d-flex justify-content-center gap-3 flex-wrap">
            ...
            <a href="<?php echo e(route('contact')); ?>" class="btn btn-outline-light btn-lg px-5 rounded-pill">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\Daria-Beauty\dariabeauty\resources\views/home.blade.php ENDPATH**/ ?>