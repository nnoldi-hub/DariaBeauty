...
<?php $__env->startSection('title', 'Cauta Specialisti - DariaBeauty'); ?>
    ...
    <section class="search-hero" style="background: linear-gradient(135deg, #D4AF37 0%, #8B6914 100%); padding: 80px 0;">
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-10">
                    <form action="<?php echo e(route('search')); ?>" method="GET" class="search-form-compact bg-white rounded-pill shadow-lg p-2">
                        <div class="row g-2 align-items-center">
                            ...
                            <div class="col-md-3">
                                <select name="zone" class="form-select border-0 rounded-pill">
                                    ...
                                    <option value="Sector 1" <?php echo e(request('zone') == 'Sector 1' ? 'selected' : ''); ?>>Sector 1</option>
                                    <option value="Sector 2" <?php echo e(request('zone') == 'Sector 2' ? 'selected' : ''); ?>>Sector 2</option>
                                    <option value="Sector 3" <?php echo e(request('zone') == 'Sector 3' ? 'selected' : ''); ?>>Sector 3</option>
                                    <option value="Sector 4" <?php echo e(request('zone') == 'Sector 4' ? 'selected' : ''); ?>>Sector 4</option>
                                    <option value="Sector 5" <?php echo e(request('zone') == 'Sector 5' ? 'selected' : ''); ?>>Sector 5</option>
                                    <option value="Sector 6" <?php echo e(request('zone') == 'Sector 6' ? 'selected' : ''); ?>>Sector 6</option>
                                </select>
                            </div>
                            <div class="col-md-3">
                                <select name="min_rating" class="form-select border-0 rounded-pill">
                                    <option value="">Orice rating</option>
                                    <option value="3" <?php echo e(request('min_rating') == '3' ? 'selected' : ''); ?>>3+ stele</option>
                                    <option value="4" <?php echo e(request('min_rating') == '4' ? 'selected' : ''); ?>>4+ stele</option>
                                    <option value="4.5" <?php echo e(request('min_rating') == '4.5' ? 'selected' : ''); ?>>4.5+ stele</option>
                                </select>
                            </div>
                            <div class="col-md-3">
            ...
            <div class="d-flex flex-wrap align-items-center justify-content-between gap-3">
                ...
                <div class="d-flex align-items-center gap-3 flex-wrap">
                    <span class="fw-semibold text-dark">
                        <i class="fas fa-users text-primary me-2"></i><?php echo e($specialists->total()); ?> specialiști
                    </span>
                    
                    <?php if(request()->hasAny(['sub_brand', 'zone', 'min_rating'])): ?>
                    <div class="d-flex gap-2 flex-wrap">
                        <?php if(request('sub_brand')): ?>
                        <span class="badge rounded-pill" style="background: rgba(212, 175, 55, 0.15); color: #D4AF37; padding: 6px 12px;">
                            <?php echo e($subBrands[request('sub_brand')]); ?>

                            <a href="<?php echo e(request()->fullUrlWithQuery(['sub_brand' => null])); ?>" class="text-decoration-none ms-1" style="color: inherit;">×</a>
                        </span>
                        <?php endif; ?>
                        
                        <?php if(request('zone')): ?>
                        <span class="badge rounded-pill bg-info bg-opacity-10 text-info" style="padding: 6px 12px;">
                            <?php echo e(request('zone')); ?>

                            <a href="<?php echo e(request()->fullUrlWithQuery(['zone' => null])); ?>" class="text-decoration-none ms-1" style="color: inherit;">×</a>
                        </span>
                        <?php endif; ?>
                        ...
                        <span class="badge rounded-pill bg-success bg-opacity-10 text-success" style="padding: 6px 12px;">
                            ...
                            <a href="<?php echo e(request()->fullUrlWithQuery(['min_rating' => null])); ?>" class="text-decoration-none ms-1" style="color: inherit;">×</a>
                        </span>
                        <?php endif; ?>
                    </div>
                    <?php endif; ?>
                ...
                <div class="d-flex align-items-center gap-3">
                    ...
                    <select name="sort" onchange="updateSort(this.value)" class="form-select form-select-sm" style="width: auto; min-width: 180px;">
                        <option value="rating" <?php echo e(request('sort') == 'rating' ? 'selected' : ''); ?>>Cel mai bine cotat</option>
                        <option value="reviews" <?php echo e(request('sort') == 'reviews' ? 'selected' : ''); ?>>Cele mai multe review-uri</option>
                        <option value="name" <?php echo e(request('sort') == 'name' ? 'selected' : ''); ?>>Nume (A-Z)</option>
                        <option value="newest" <?php echo e(request('sort') == 'newest' ? 'selected' : ''); ?>>Cei mai noi</option>
                    </select>
                </div>
            </div>
        </div>
    ...
    <section class="specialists-section py-5">
        <div class="container">
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="specialist-card-compact bg-white rounded-4 shadow-sm overflow-hidden h-100" 
                        ...
                        <div class="position-relative" style="height: 200px; overflow: hidden;">
                            <?php if($specialist->profile_picture): ?>
                            <img src="<?php echo e(asset('storage/' . $specialist->profile_picture)); ?>" 
                                 alt="<?php echo e($specialist->name); ?>" 
                            ...
                            <div class="position-absolute top-0 start-0 end-0 p-2 d-flex justify-content-between align-items-start">
                                ...
                                <span class="badge rounded-pill px-3 py-2 text-white fw-semibold" 
                                      style="background: <?php echo e($subBrandColors[$specialist->sub_brand] ?? '#D4AF37'); ?>; font-size: 0.7rem;">
                                    <?php echo e($subBrands[$specialist->sub_brand] ?? 'DariaBeauty'); ?>

                                </span>
                                <?php endif; ?>
                                
                                <span class="badge bg-white text-warning fw-bold px-3 py-2 shadow-sm">
                                    ⭐ <?php echo e(number_format($specialist->average_rating, 1)); ?>
                        ...
                        <div class="p-3">
                            <h5 class="fw-bold mb-2" style="font-size: 1.1rem;"><?php echo e($specialist->name); ?></h5>
                            
                            <!-- Rating -->
                            <div class="d-flex align-items-center gap-2 mb-3">
                                <div class="text-warning" style="font-size: 0.85rem;">
                                    <?php for($i = 1; $i <= 5; $i++): ?>
                                        <?php if($i <= floor($specialist->average_rating)): ?>
                                            ★
                                        <?php elseif($i - 0.5 <= $specialist->average_rating): ?>
                                            ⯨
                                        <?php else: ?>
                                            ☆
                                        <?php endif; ?>
                                ...
                                <small class="text-muted">(<?php echo e($specialist->reviews->count()); ?>)</small>
                            </div>

                            <!-- Location -->
                            <?php if($specialist->coverage_area): ?>
                            <div class="mb-2">
                                <small class="text-muted">
                                    ...
                                    ?>
                                    <?php echo e(Str::limit($coverage, 30)); ?>
                            ...
                            <?php if($specialist->services && $specialist->services->count() > 0): ?>
                            <div class="mb-3">
                                <div class="d-flex flex-wrap gap-1">
                                    <?php $__currentLoopData = $specialist->services->take(2); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <span class="badge bg-light text-dark border" style="font-size: 0.7rem; font-weight: 500;">
                                        <?php echo e(strlen($service->name) > 15 ? substr($service->name, 0, 15) . '...' : $service->name); ?>

                                    </span>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    <?php if($specialist->services->count() > 2): ?>
                                    <span class="badge" style="background: rgba(212,175,55,0.2); color: #D4AF37; font-size: 0.7rem;">
                                        +<?php echo e($specialist->services->count() - 2); ?>
                            ...
                            <div class="d-flex gap-2">
                                <a href="<?php echo e(route('specialist.profile', $specialist->slug ?? $specialist->id)); ?>" 
                                   class="btn btn-sm btn-outline-primary flex-fill" style="font-size: 0.85rem;">
                                    Profil
                                </a>
                                <a href="<?php echo e(route('booking.landing')); ?>?specialist=<?php echo e($specialist->id); ?>" 
                    ...
                    <div class="row align-items-center g-3">
                        ...
                        <div class="col">
                            <div class="d-flex align-items-start justify-content-between">
                                <div>
                                    <h5 class="fw-bold mb-1"><?php echo e($specialist->name); ?></h5>
                                    <div class="d-flex align-items-center gap-3 mb-2">
                                        <div class="text-warning" style="font-size: 0.9rem;">
                                            <?php for($i = 1; $i <= 5; $i++): ?>
                                                ...
                                                <?php endif; ?>
                                            <?php endfor; ?>
                                            <span class="text-dark ms-1"><?php echo e(number_format($specialist->average_rating, 1)); ?></span>
                                        </div>
                                        <small class="text-muted">(<?php echo e($specialist->reviews->count()); ?> review-uri)</small>
                                        <?php if($specialist->sub_brand): ?>
                                        <span class="badge rounded-pill px-2 text-white" 
                                              style="background: <?php echo e($subBrandColors[$specialist->sub_brand] ?? '#D4AF37'); ?>; font-size: 0.7rem;">
                                            <?php echo e($subBrands[$specialist->sub_brand]); ?>
                                    ...
                                    <?php if($specialist->services && $specialist->services->count() > 0): ?>
                                    <div class="d-flex flex-wrap gap-1">
                                        <?php $__currentLoopData = $specialist->services->take(4); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="text-center py-5">
                ...
                <a href="<?php echo e(route('search')); ?>" class="btn btn-primary">Resetează căutarea</a>
            </div>
            <?php endif; ?>
        </div>
    </section>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\Daria-Beauty\dariabeauty\resources\views/specialists/index.blade.php ENDPATH**/ ?>