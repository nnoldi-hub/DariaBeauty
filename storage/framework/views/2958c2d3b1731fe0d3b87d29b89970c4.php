...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'DariaBeauty - Frumusetea ta, in maini bune'); ?></title>
    <meta name="description" content="<?php echo $__env->yieldContent('description', 'DariaBeauty - servicii de frumusete premium la domiciliu. dariaNails, dariaHair, dariaGlow. Programeaza acum!'); ?>">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(url('/')); ?>">Acasa</a>
                    </li>
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="<?php echo e(route('darianails')); ?>">
                                <i class="fas fa-hand-sparkles text-danger me-2"></i>dariaNails
                            </a></li>
                            <li><a class="dropdown-item" href="<?php echo e(route('dariahair')); ?>">
                                <i class="fas fa-cut text-purple me-2"></i>dariaHair
                            </a></li>
                            <li><a class="dropdown-item" href="<?php echo e(route('dariaglow')); ?>">
                                <i class="fas fa-spa text-warning me-2"></i>dariaGlow
                            </a></li>
                            <li><hr class="dropdown-divider"></li>
                            <li><a class="dropdown-item" href="<?php echo e(route('services')); ?>">Toate serviciile</a></li>
                        </ul>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(route('specialists.index')); ?>">Specialisti</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(route('gallery')); ?>">Galerie</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(route('contact')); ?>">Contact</a>
                    </li>
                    <li class="nav-item ms-3">
                        <a class="btn btn-primary" href="<?php echo e(route('booking.landing')); ?>">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-2 mb-4">
                    ...
                    <ul class="list-unstyled">
                        <li><a href="<?php echo e(route('darianails')); ?>" class="text-white-50 text-decoration-none">dariaNails</a></li>
                        <li><a href="<?php echo e(route('dariahair')); ?>" class="text-white-50 text-decoration-none">dariaHair</a></li>
                        <li><a href="<?php echo e(route('dariaglow')); ?>" class="text-white-50 text-decoration-none">dariaGlow</a></li>
                    </ul>
                </div>
                <div class="col-lg-3 mb-4">
                    <h6 class="text-warning mb-3">Servicii</h6>
                    <ul class="list-unstyled">
                        <li><a href="<?php echo e(route('services')); ?>" class="text-white-50 text-decoration-none">Servicii la domiciliu</a></li>
                        <li><a href="<?php echo e(route('services')); ?>" class="text-white-50 text-decoration-none">Consultanta frumusete</a></li>
                        <li><a href="<?php echo e(route('services')); ?>" class="text-white-50 text-decoration-none">Evenimente speciale</a></li>
                    </ul>
                </div>
                <div class="col-lg-3">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6 text-md-end">
                    <a href="<?php echo e(route('terms')); ?>" class="text-white-50 text-decoration-none me-3">Termeni si conditii</a>
                    <a href="<?php echo e(route('privacy')); ?>" class="text-white-50 text-decoration-none me-3">Politica de confidentialitate</a>
                    <a href="<?php echo e(route('cookies')); ?>" class="text-white-50 text-decoration-none"><i class="fas fa-cookie-bite me-1"></i>Setari Cookies</a>
                </div>
            </div>
        </div>
    </footer>
...
</html><?php /**PATH C:\wamp64\www\Daria-Beauty\dariabeauty\resources\views/layout.blade.php ENDPATH**/ ?>